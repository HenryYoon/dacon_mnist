...
parser.add_argument('--split_ratio', type=float,
                    default=.1, help='train-val data ratio')
...
parser.add_argument('--resize_pixel', type=int,
                    default=100, help='Resize pixel')
parser.add_argument('--random_affine', type=int, default=10,
                    help='Random affine transformation ratio')
